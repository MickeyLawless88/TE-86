...
#define COPYRIGHT "(c) Mickey W. Lawless"
...
/* ---------------------------------------------------------------
   ...
   Uses intensity and underline bits only - no colour.
     0x07 = normal
     0x0F = bright (bold)
     0x01 = underline
     0x09 = bright underline
   --------------------------------------------------------------- */
#define HL_MONO_NORMAL   0x07   /* normal                - plain text  */
#define HL_MONO_KEYWORD  0x0F   /* bright/bold           - keywords    */
#define HL_MONO_STRING   0x09   /* bright + underline    - strings     */
#define HL_MONO_COMMENT  0x01   /* underline             - comments    */
#define HL_MONO_NUMBER   0x0F   /* bright/bold           - numbers     */
#define HL_MONO_PREPROC  0x09   /* bright + underline    - preprocessor*/
#define HL_MONO_OPERATOR 0x0F   /* bright/bold           - operators   */
